...
NEIGHBORLY_REPOSITORY = 'http://localhost:8080/openrdf-sesame/repositories/neighborly'


@app.route('/')
def first_page():
    app.logger.debug('You arrived at ' + url_for('first_page'))
    return render_template('IWAgroup08App.html')
...
def store():
    ...
    url = NEIGHBORLY_REPOSITORY + "/statements"
